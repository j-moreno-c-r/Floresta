...
def florestad_with_tls(node_manager) -> Node:
    ...
    node = node_manager.create_node(variant="florestad", tls=True, testname="pytest_florestad_tls")
    node_manager.start_node(node)
    return node
...
def multi_node_setup(node_manager) -> Dict[str, Node]:
    ...
    florestad = node_manager.create_node(variant="florestad", testname="pytest_multi_floresta")
    bitcoind = node_manager.create_node(variant="bitcoind", testname="pytest_multi_bitcoin")
...
def three_node_setup(node_manager) -> Dict[str, Node]:
    ...
    florestad = node_manager.create_node(variant="florestad", testname="pytest_three_floresta")
    bitcoind = node_manager.create_node(variant="bitcoind", testname="pytest_three_bitcoin")
    utreexod = node_manager.create_node(variant="utreexod", testname="pytest_three_utreexo")
...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "multi_node: marks tests that use multiple nodes")
    config.addinivalue_line("markers", "rpc: marks tests focused on RPC calls")
    config.addinivalue_line("markers", "electrum: marks tests for electrum server functionality")
